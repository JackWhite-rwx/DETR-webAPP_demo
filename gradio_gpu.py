...
model = detr_resnet50(pretrained=True).cuda()
model.eval()
...
if __name__ == '__main__':
    interface = gr.Interface(fn=inference, inputs=inputs, outputs="image", title=title, description=description, article=article, examples=examples)
